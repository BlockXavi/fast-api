...
# Modificar la función get_all_users para permitir la recuperación de usuarios utilizando
# parámetros de consulta (query params) para filtrar por nombre y/o correo electrónico
# y/o edad.
@app.get("/users")
